...
![Історичний облік часу: частина A, частина B та окрема робота агентів](../docs/images/timelog-uk.png)

> **Історичний запис, а не новий замір.** Підсумки й округлення збережено такими, як їх було наведено автором. Діаграма показує ці самі заявлені підсумки й не додає нових годин. Результати в хронології описують стан на той момент; актуальні результати оцінювання — в [EVAL](EVAL.md). Раніший підрахунок за подіями та його обмеження наведено в [методиці обліку часу](../docs/TIME.md); його не слід додавати до цього ретроспективного підсумку.
