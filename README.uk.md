...
**Part B — автоматизація процесів:** [тут](PART_B_DAILY_LOG_AUTOMATION.md#українська-версія)
...
**[Читати частину B — Daily Log Automation](PART_B_DAILY_LOG_AUTOMATION.md#українська-версія)** · [Стисла версія для здачі англійською](PROCESS.md)

У повному документі спочатку український текст, нижче — англійський переклад. Це опис запропонованого процесу, окремий від застосунку частини A.
...
Відомі межі: неповне охоплення відео, відсутність читання фактів із картинок, можливі помилки пошуку та модельних перевірок. Детальні рішення, свідомі скорочення обсягу та пріоритети на місяць — у [українському REPORT](REPORT.uk.md). Для усного пояснення є [короткі нотатки українською](docs/DEFENCE.md).
