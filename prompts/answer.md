...
{"action":"answer","status":"answered","claims":[{"text":"one supported claim without citation markers","citations":["exact passage ID"],"asOf":"YYYY-MM-DD"}],"reason":"brief explanation if no answer"}
