...
**Delivery validation is in progress.** Final measured results belong in [EVAL.md](EVAL.md), [COST.md](COST.md) and [REPORT.md](REPORT.md). The separate demo target is `https://everstate-knowledge-base.89-167-19-222.sslip.io`.
