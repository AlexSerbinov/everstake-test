...
![Якість і вартість на одному наборі з двадцяти запитань](docs/images/report-results-uk.png)
...
Історичні 19/20 дослідника та 11/20 базового варіанта стосуються попереднього корпусу й набору. У `core-v2` пошук року заснування замінено складнішим питанням про схвалення, запуск, прогнози та голосування. Нового базового прогону не було. Відсотки різних наборів не є контрольованим порівнянням покращення чи погіршення. Оцінювання виконав окремий coding assistant; це не людська сертифікація й не сліпий тест. [Історичні результати](docs/evaluation/general-quality/EVAL-previous.md).
