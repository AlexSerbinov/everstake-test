...
The [English time chart](timelog-en.png) and [Ukrainian time chart](timelog-uk.png) visualize the historical rounded human-time totals in TIMELOG. Regenerate them with [render-timelog.py](../../scripts/docs/render-timelog.py); background agent time is kept separate.
