...
Three English diagrams explain the [researcher configuration](../../agents/README.md), [server modules](../../src/README.md), and [saved evidence](../../artifacts/README.md). They reuse the same drawing style and are embedded in those folders’ READMEs.
...
The [English report](../../REPORT.md) and [Ukrainian report](../../REPORT.uk.md) use a responsibility map and a measured quality/cost comparison. The latter reads the saved `agent-cdf52dda` and `mcp-core-v2` runs; it does not run another evaluation.
